...
contract Theirsverse is Ownable, ERC721A, Pausable, AccessControl, ReentrancyGuard {
    ...
    function publicSaleMint(
        uint256 _quantity
    ) external payable whenNotPaused _notContract _saleBetweenPeriod(2, 3) nonReentrant {
        require(
            amountNFTsPerPublicSale[msg.sender] + _quantity <= 1,
    ...
    function batchClaim(
        ...
        require(
            ...
            "Accounts and quantities must have the same length"
        );
